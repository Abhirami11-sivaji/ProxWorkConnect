...
<html>
    <head>
        ...
        <title>Complaint Worker</title>
    </head>
    <body>
        <%
            if (request.getParameter("btn_submit") != null) {
                String insqry = "insert into tbl_complaint (complaint_title,complaint_content, complaint_date, user_id,worker_id) values ( '" + request.getParameter("title") + "','" + request.getParameter("content") + "',curdate(), '" + session.getAttribute("uid") + "','" + request.getParameter("cid") + "')";
               out.println(insqry);
