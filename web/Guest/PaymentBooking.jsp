<%-- 
    Document   : PaymentBooking
    Created on : 20 May, 2024, 11:11:50 PM
    Author     : abhij
--%>
...
<%
    ...
    String selQry="select * from tbl_workpostrequest w inner join tbl_workpost p on p.workpost_id=w.workpost_id where request_id='"+preq+"'";
                ...
                String upQ="update tbl_workpostrequest set request_status='5' where request_id='"+request.getParameter("yid")+"'";
                    ...
                    if(con.executeCommand(upQ))
                   {
                    ...
                    <script>
                            ...
                            window.location="BookingDisplay.jsp";
                    </script>
                    <%
                }
                else{
