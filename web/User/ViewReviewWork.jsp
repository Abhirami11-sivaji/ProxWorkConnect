        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="txt_lid" id="txt_lid" value="<%=request.getParameter("gid")%>" />
                </div>
                <div class="form-group">
        ...
        $('#save_review').click(function() {
            ...
            else
            {
                $.ajax({
                    ...
                    method: "POST",
                    data: {rating_data: rating_data, user_name: user_name, user_review: user_review, workpost_id: workpost_id},
