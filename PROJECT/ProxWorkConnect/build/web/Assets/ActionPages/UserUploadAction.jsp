...
//checking if request cotains multipart data
           ...
           //f_item=(FileItem)itr.next();
                ...
                {
                String str1 = "insert into tbl_user(user_name,user_contact,user_email,user_address,user_dob,user_photo,user_gender,user_password,location_id)"
                        + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + ph + "','" + value[5] + "','" + value[6] + "','" + value[10] + "')";
